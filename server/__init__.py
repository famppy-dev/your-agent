...
MILVUS_EMBEDDING_IMG_FIELD = os.getenv("MILVUS_EMBEDDING_IMG_FIELD")
MILVUS_TEXT_FIELD = os.getenv("MILVUS_TEXT_FIELD")

EMBED_MODEL = os.getenv("EMBED_MODEL")
EMBED_RERANK_MODEL = os.getenv("EMBED_RERANK_MODEL")
EMBED_IMG_MODEL = os.getenv("EMBED_IMG_MODEL")
